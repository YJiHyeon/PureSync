...
const DepressionResult = () => {
  ...
  return (
    <div className="result-container">
      ...
      <p>16점 미만 : 우울하지 않은 상태입니다.</p><br />
      <p>16 ~ 24점 : 가벼운 ~ 중간 정도의 우울 상태입니다. 주위 사람들에게 도움을 청해보세요.</p><br />
      <p>25점 이상 : 심한 우울 상태입니다. 현재 우울감, 절망감, 삶에 대한 불만족감을 경험하고 계실 가능성이 높아 보입니다. 상담센터에 방문하시어 추가적인 검사를 받아보시거나, 전문가와 자신의 상태에 대해 이야기해 볼 것을 권합니다.</p><br />
